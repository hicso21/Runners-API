    ...
    static async setStats(req, res) {
        try {
            ...
            const dataToSend = {
                ...
                distance: parseFloat(data[0]?.distance),
                total_time: parseFloat(data[0]?.elapsed_time),
                average_heart_rate: parseFloat(data[0]?.average_heartrate),
                max_heart_rate: parseFloat(data[0]?.max_heartrate),
                resting_heart_rate: '',
                average_pace: '',
                calories: parseFloat(
                    `${fromKilojouleToCalories(data[0]?.kilojoules)}`
                ),
