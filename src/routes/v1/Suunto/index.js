...
router.get('/exchange_token', SuuntoController.getToken);
router.get('/webhook', SuuntoController.getWebhook)
...
router.post('/webhook', SuuntoController.webhook)
router.post('/setStats', SuuntoController.setStats)
